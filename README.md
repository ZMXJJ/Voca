...
| Disk Space | ~6 GB (app + models) | ~6 GB CPU build; CUDA upgrade requires ~5 GB additional disk space (download ~2.5 GB) |
...
> **Note:** The CUDA runtime installation requires approximately **5 GB** of additional free disk space. Please ensure sufficient space is available before upgrading.
