const en = {
  ...
  settings: {
    ...
    modelManagement: {
      ...
      desc: {
        voxcpm2: "High-quality TTS with emotion & style control — GGUF, lightweight GPU (Metal/CUDA/Vulkan) inference",
        voxcpm1_5: "Balanced quality and speed — GGUF, lightweight GPU inference",
        voxcpm_05b: "Lightweight TTS, fastest inference — GGUF, GPU-accelerated",
