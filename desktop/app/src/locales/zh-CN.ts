const zhCN = {
  ...
  bootstrap: {
    ...
    init: {
      ...
      deviceTitle: "设备信息",
      deviceTitleCpu: "设备型号与内存",
      deviceTitleGpu: "GPU 型号与显存",
      storageTitle: "可用存储空间",
      environmentTitle: "本地运行环境",
      memoryHealthy: "设备总内存 {{memory}}，满足推荐配置。",
      memoryWarning: "内存仅 {{memory}}，低于推荐的 {{recommended}}，运行时可能出现卡顿。",
      vulkanMissing: "未检测到 Vulkan 支持。请安装或更新显卡驱动——任何支持 Vulkan 的 GPU 均可运行推理。",
      lowVramHint: "显存偏低，生成速度可能较慢",
  ...
  history: {
    title: "作品库",
    searchPlaceholder: "按文本或音色搜索…",
    filterAllVoices: "全部音色",
    unknownVoice: "未知音色",
    count: "{{count}} 个作品",
    empty: "还没有作品，去工作台生成一段吧",
  ...
  settings: {
    ...
    inferenceBackend: {
      ...
      vulkanReady: "此设备支持 Vulkan GPU 推理。任何支持 Vulkan 的 GPU（NVIDIA / AMD / Intel）都可以运行语音引擎。",
      vulkanMissing: "未检测到 Vulkan 支持。请安装或更新显卡驱动以启用 GPU 推理。",
      lowVram: "当前检测到的显存为 {{memory}}，低于推荐的 {{minimum}}。推理可以运行，但速度可能较慢。",
    },
    modelManagement: {
      title: "模型管理",
      count: "{{count}} 个模型",
      ...
      roleEnhancer: "音频增强",
      desc: {
        voxcpm2: "高质量语音合成，支持情感与风格控制 —— GGUF，轻量级 GPU（Metal/CUDA/Vulkan）推理",
        voxcpm1_5: "平衡质量与速度 —— GGUF，轻量级 GPU 推理",
        voxcpm_05b: "轻量级语音合成，推理最快 —— GGUF，GPU 加速",
  ...
  preview: {
    ...
    sim: {
      ...
      injectFailure: "注入失败",
      profiles: {
        "mac-silicon": "Mac（Apple 芯片）",
        "mac-low-ram": "Mac（8GB 内存）",
        "win-nvidia": "Windows（RTX 4070）",
        "win-igpu": "Windows（Intel 核显）",
        "win-no-vulkan": "Windows（无 Vulkan）",
        "win-low-vram": "Windows（4GB 显存）",
        "low-storage": "磁盘空间不足",
      },
      speeds: {
        fast: "高速（60 MB/s）",
